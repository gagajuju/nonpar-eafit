...
In Section \@ref(dens-kdeasymp) we assumed certain regularity conditions for $f$. Assumption **A1** stated that $f$ should be twice continuously differentiable (on $\mathbb{R}$). It is simple to think a counterexample for that: take any density with bounded support, for example a $\mathcal{LN}(0,1)$ in $(0,\infty)$, as seen below.
...
- Estimate the uknown density from sample of size $n=1000$.
