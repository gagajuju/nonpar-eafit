...
```{r, movinghist, echo = FALSE, fig.cap = '(ref:movinghisttile)', screenshot.alt = "images/screenshots/bias-var-movhist.png", dev = 'png', cache = TRUE, out.width = '70%'}
...
```{r, kdeconst, echo = FALSE, fig.cap = '(ref:kdeconsttitle)', screenshot.alt = "images/screenshots/kde.png", dev = 'png', cache = TRUE, out.width = '70%'}
...
\end{align}
Since $h\to0$, an applycation of a scond-order Taylor expansion gives
\begin{align}
...
```{r, effective, echo = FALSE, fig.cap = 'Illustration of the effective sample size for estimating $f(x)$ at $x=2$. In blue, the kernels with contribution larger than $0.01$ to the kde. In grey, rest of the kernels.', dev = 'png', cache = TRUE, out.width = '70%'}
n <- 25
h <- 0.2
set.seed(1234567)
...
```{r, kdebwd, echo = FALSE, fig.cap = '(ref:kdebwdtitle)', screenshot.alt = "images/screenshots/kde-bwd.png", dev = 'png', cache = TRUE, out.width = '70%'}
...
```{r, kdetransf, echo = FALSE, fig.cap = '(ref:kdetransftitle)', screenshot.alt = "images/screenshots/kde-transf.png", dev = 'png', cache = TRUE, out.width = '70%'}
