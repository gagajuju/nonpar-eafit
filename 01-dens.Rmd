...
```{r, effective, echo = FALSE, fig.cap = 'Illustration of the effective sample size for estimating $f(x)$ at $x=2$. In blue, the kernels with contribution larger than $0.01$ to the kde. In grey, rest of the kernels.', dev = 'png', cache = TRUE, out.width = '90%'}
n <- 25
h <- 0.2
set.seed(1234567)
...
```{r, kdetransf, echo = FALSE, fig.cap = 'Construction of the transformation kde for the log and probit transformations. The left panel shows the kde \\@ref(eq:kde) applied to the transformed data. The right plot shows the transformed kde \\@ref(eq:tkde). Application also available [here](https://ec2-35-177-34-200.eu-west-2.compute.amazonaws.com/kde-transf/).', screenshot.alt = "TODO.png", dev = 'png', cache = TRUE, out.width = '90%'}
