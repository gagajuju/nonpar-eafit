...
```{r, rstudio, echo = FALSE, out.width = '90%', fig.align = 'center', fig.cap = 'Main window of `RStudio`. The red showws the code panel and the yellow shows the console output. Extracted from <https://www.rstudio.com/wp-content/uploads/2016/01/rstudio-IDE-cheatsheet.pdf>.', cache = TRUE}
...
- Create a function that takes as argument $n$ and returns the value of $\sum_{i=1}^ni^2.
