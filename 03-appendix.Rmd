...
```{r, rstudio, echo = FALSE, out.width = '90%', fig.cap = 'Main window of `RStudio`. The red showws the code panel and the yellow shows the console output. Extracted from [here](https://www.rstudio.com/wp-content/uploads/2016/01/rstudio-IDE-cheatsheet.pdf).', cache = TRUE}
